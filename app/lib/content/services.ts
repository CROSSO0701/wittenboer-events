...
export const services: Service[] = [
  {
    slug: 'geluid',
    title: 'Geluid',
    lead: 'Goed geluid op uw kantoor feestje of een festival met 5000 bezoekers? Wij regelen beide.',
    body:
  ...
  },
  {
    slug: 'licht',
    title: 'Licht',
    lead: 'Een goede belichting bepaalt de gehele sfeer van uw evenement.',
    body:
  ...
  },
  {
    ...
    body:
      'Wij draaien de tapes voor een groot aantal artiesten in Nederland. Bespreek met ons welke artiest u boekt, en wij zorgen dat hun show technisch soepel verloopt. Een tape-operator van ons staat naast de artiest op de bühne of in de techniek, afhankelijk van de wens.',
  },
  {
  ...
  },
  {
    ...
    lead: 'End-to-end coördinatie — van eerste gesprek tot en met de afbouw.',
    body:
      'Wilt u één aanspreekpunt voor uw hele evenement? Wij nemen de volledige productie uit handen. Van locatie-inspectie, vergunningenadvies, leveranciersselectie, planning, techniek, artiesten en crewmanagement tot evaluatie. U hoeft alleen te genieten.',
  },
]
