export const home = {
  ...
  approach: {
    label: 'Hoe we werken',
    heading: 'Geen gedoe. Eén aanspreekpunt.',
    steps: [
      {
        number: '01',
        title: 'Bellen',
        body:
          'Je belt of mailt. We komen langs op de locatie, of we regelen het telefonisch. Geen verkooppraatje.',
      },
      {
        number: '02',
        title: 'Plan',
        body:
          'Technisch ontwerp, geluidsmetingen, artiesten, vergunningen. Je krijgt een draaiboek waarin alles klopt.',
      },
      {
        number: '03',
        title: 'Knallen',
        body:
          'Wij bouwen op, draaien de show, breken af. Jij concentreert je op de gasten. Wij op de techniek.',
      },
    ],
  },
  featuredWork: {
