export const about = {
  ...
  whyUs: [
    ...
    },
    {
      ...
      body:
        'Je belt met Marnix, niet met een planner. De persoon die het plan maakt, staat ook op de dag zelf naast je.',
    },
    {
      title: 'Flexibel',
      body:
  ...
  closing: {
    heading: 'Klaar om mee te denken over jouw evenement?',
    cta: 'Neem contact op',
    href: '/contact',
  },
}
