...
const FAQ = [
  {
    ...
    a: 'Nee, de pakketten zijn de techniek (licht, geluid, opbouw). Een DJ kun je via ons boeken als losse aanvulling, of je regelt er zelf één. We werken samen met meerdere DJ\'s en kunnen er één voorstellen die bij jouw avond past.',
  },
  {
  ...
  },
  {
    ...
    a: 'Voor zaterdagen in mei–oktober en december: liefst 3–6 maanden vooruit. Doordeweekse data of buiten het seizoen kan vaak nog binnen 2–4 weken. Bel even, soms hebben we last-minute capaciteit.',
  },
  {
      ...
      >
        <div className="container page-header__inner" data-reveal-stagger>
          ...
          <p className="page-header__lead">
            ...
            op, draaien de show, breken af. Jij hoeft alleen de datum te bevestigen.
          </p>
        </div>
      </header>
          ...
          <ul className="pkg-intro__bullets" data-reveal data-reveal-delay="2">
            <li className="pkg-intro__bullet">
              ...
              <div>
                ...
                <span>Inclusief transport, montage, programmering en demontage. Geen gedoe achteraf.</span>
              </div>
            </li>
            <li className="pkg-intro__bullet">
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            <li className="pkg-intro__bullet">
              ...
              <div>
                ...
                <span>Niet zeker wat je nodig hebt? Bel even, we adviseren eerlijk, ook als dat een kleiner pakket is.</span>
              </div>
            </li>
          </ul>
        </div>
        ...
        <div className="container">
          ...
          <div className="incl__grid" data-reveal-stagger>
            ...
            <div className="incl__item">
              ...
              <h3>Opbouw &amp; afbouw</h3>
              <p>Twee technici komen 2–4 uur voor aanvang. Na afloop alles weer mee. Jij hoeft niets.</p>
            </div>
            <div className="incl__item">
              <div className="incl__icon">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            <div className="incl__item">
              ...
              <h3>Aanspreekpunt</h3>
              <p>Eén nummer voor de hele avond. Iets gaat fout? Wij lossen het op zonder dat jij merkt dat het er was.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="pkg-flow__grid" data-reveal-stagger>
            ...
            <div className="pkg-flow__step">
              ...
              <p>Opbouw, programmering, show, afbouw. Jij hoeft alleen te genieten van de avond.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="closing" style={{ background: 'var(--color-surface-dark)', color: 'var(--color-fg-on-dark)' }}>
        <div className="container">
          ...
          <p style={{ color: 'var(--color-fg-on-dark-muted)', margin: '0 auto 32px', maxInlineSize: '52ch', fontSize: 17 }}>
            Korte aanvraag is genoeg. Datum, locatie, welk pakket je in gedachten hebt. Wij
